...
Reads cases.json in the run dir (written by build_cases.py). NOTHING is executed.
    ...
    python3 mcp/elm-mcp/src/plot_columns.py --run-dir <dir> --cases-file cases.json --surfaces
    python3 mcp/elm-mcp/src/plot_columns.py --run-dir <dir> --cases-file cases.json --timeseries
"""
import argparse
import glob
import json
