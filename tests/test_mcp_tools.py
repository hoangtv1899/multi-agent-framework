...
class TestExpander:
    ...
    # test_clip_to_polygon, test_clip_to_polygon_never_drops_all and
    # test_plot_columns_renders stood here and are deleted (2026-08-18): all
    # three tested functions that no longer exist — plot_columns went on
    # 2026-08-13, _clip_to_polygon on 2026-08-18 when the sampler stopped
    # re-clipping a grid reception had already clipped.
