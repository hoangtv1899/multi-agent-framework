...
# ELMResultsAnalyzer deleted 2026-08-13. Reading history files is extract.py's
# job now and row assembly is column_rows.py's; the class that tested it
# (TestELMResultsAnalyzerReal) went with it.
